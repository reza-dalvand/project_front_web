...
/**
 * 🔥 آگهی‌های تبلیغاتی
 * استفاده شده در: صفحه اصلی (اسلایدر)، صفحه همه آگهی‌ها
 */
export const MOCK_ADS = [
  {
    ...
    badge: 'پیشنهاد ویژه',
    businessName: 'کلینیک زیبایی رُز', city: 'تهران، ونک',
  },
  {
    id: 2, businessId: '2',
    ...
    badge: 'جدید',
    businessName: 'سالن زیبایی لاویا', city: 'تهران، نیاوران',
  },
  {
    id: 3, businessId: '3',
    ...
    badge: 'پرفروش',
    businessName: 'مرکز لیزر رویال', city: 'تهران، شهرک غرب',
  },
];