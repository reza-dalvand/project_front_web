...
import { FiPlus, FiX, FiClock, FiCoffee } from 'react-icons/fi';
    ...
    <div className="flex flex-col gap-4 px-4">
        ...
        >
          <div className="flex gap-3">
            <TimePickerField
              ...
              color="#43A047"
            />
            <div className="flex items-end pb-3 text-lg" style={{ color: colors.textSecondary }}>
              ←
            </div>
            <TimePickerField
              label="ساعت پایان"
          ...
          <div className="flex flex-wrap gap-2">
            {SLOT_DURATIONS.map((d) => (
              <button
                ...
                className="px-3.5 py-2.5 rounded-xl border text-xs font-[Vazir-Bold] transition-all"
                style={{
      ...
      <div className="flex flex-col gap-2">
        <div className="flex items-center justify-between">
          ...
          {breaks.length > 0 && (
            <span
              className="px-2.5 py-1 rounded-lg text-[11px] font-[Vazir-Bold]"
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-2 mb-2.5">
                    <div
                      className="w-6 h-6 rounded-full flex items-center justify-center text-[11px] font-[Vazir-Bold] text-white"
                    ...
                    {breakDuration > 0 && (
                      <span
                        className="px-2 py-0.5 rounded-lg text-[10px] font-[Vazir-Bold]"
                  ...
                  <div className="flex gap-3">
                    <TimePickerField
                      ...
                      color="#FF9800"
                    />
                    <div className="flex items-end pb-3 text-xs" style={{ color: colors.textSecondary }}>
                      تا
                    </div>
                    <TimePickerField
                      label="تا ساعت"
                  ...
                  {!isBreakValid && workStartMin > 0 && workEndMin > 0 && (
                    <div className="flex items-center gap-1 mt-2">
                      <span className="text-[10px]" style={{ color: '#E53935' }}>⚠️</span>
                      <span className="text-[10px]" style={{ color: '#E53935' }}>
      ...
      >
        <div className="flex items-center gap-2 mb-2">
          <span className="text-base">{availableSlots.length > 0 ? '📋' : '⚠️'}</span>
          <span
        ...
        {availableSlots.length > 0 ? (
          <div className="flex flex-wrap gap-1.5">
            {availableSlots.slice(0, 12).map((slot, idx) => (
              <span
                key={idx}
                className="px-2.5 py-1.5 rounded-lg text-[10px] font-[Vazir-Bold] border"
                style={{
            ...
            {availableSlots.length > 12 && (
              <span
                className="px-2.5 py-1.5 rounded-lg text-[10px] font-[Vazir] border"
                style={{
