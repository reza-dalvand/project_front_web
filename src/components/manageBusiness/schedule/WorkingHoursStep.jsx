...
import { FiPlus, FiX, FiClock, FiInfo, FiCheck } from 'react-icons/fi';
import { useTheme } from '@/stores/useThemeStore';
import TimePickerField from './TimePickerField';
import { toPersianDigit, toEnglishDigits } from '@/utils/numberUtils';
import { minutesToTime, timeToMinutes } from '@/utils/dateUtils';

// ✅ حذف شد: SLOT_DURATIONS — دیگه نیازی به انتخاب دستی نیست
...
/**
 * ✅ حذف شد: prop onSlotDurationChange
 * slotDuration فقط خواندنی از service می‌آید
 */
export default function WorkingHoursStep({
  workStart,
  workEnd,
  slotDuration, // ✅ فقط خواندنی — از service
  breaks,
  onWorkStartChange,
  onWorkEndChange,
  onBreaksChange,
  ...
  return (
    <div className="flex flex-col gap-4 px-3 sm:px-4 w-full max-w-full overflow-hidden">
      ...
      {/* ═══ ✅ بخش ۲ حذف شد: مدت هر نوبت ═══
جایگزین: باکس اطلاعاتی فقط‌خواندنی */}
      <div
