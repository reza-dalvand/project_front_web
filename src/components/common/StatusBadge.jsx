...
export default function StatusBadge({ meta, size = 'md', showIcon = true }) {
  ...
  const sizes = {
    sm: { container: 'px-2 py-1 rounded-lg gap-1', text: 'text-[9px]' },
    md: { container: 'px-2.5 py-1.5 rounded-xl gap-1', text: 'text-[11px]' },
    lg: { container: 'px-3.5 py-2 rounded-xl gap-1.5', text: 'text-[13px]' },
  };
  ...
  return (
    <div
      className={`inline-flex items-center self-start ${currentSize.container}`}
