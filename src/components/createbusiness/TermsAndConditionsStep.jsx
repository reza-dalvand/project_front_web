      ...
      <div className="flex-1 overflow-y-auto px-5 pt-6 pb-4 space-y-6">
              ...
              <div key={step.id} className="flex gap-4">
                ...
                <div className={`flex-1 ${!isLast ? 'pb-5' : ''}`}>
                  <div
                    ...
                    style={{
                      backgroundColor: isFirst ? step.color + '08' : colors.cardBackground,
                      borderColor: isFirst ? step.color + '40' : colors.border,
                    }}
                  >
        ...
        >
          <button
            ...
            style={{
              backgroundColor: accepted ? colors.primary + '08' : colors.cardBackground,
            }}
          >
            {/* چک‌باکس */}
            <div
